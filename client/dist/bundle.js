...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	  ...
	  var messages$ = sources.WS.map(function (e) {
	    ...
	    mMtemp.ret(e.data.split(',')[0]).bnd(next, 'CA#$42', mMZ10).bnd(next, 'XX#$42', mMZ11).bnd(next, 'CC#$42', mMZ12).bnd(next, 'CD#$42', mMZ13).bnd(next, 'CE#$42', mMZ14).bnd(next, 'EE#$42', mMZ15).bnd(next, 'DE#$42', mMZ16)
	    // .bnd(next, 'DD#$42', mMZ17)
	    .bnd(next, 'CG#$42', mMZ18).bnd(next, 'NN#$42', mMZ19);
	  });
	  ...
	  var calcStream$ = (0, _most.merge)(chatClickAction$, gameClickAction$, captionClickAction$, groupPressAction$, rollClickAction$, messagePressAction$, loginPressAction$, messages$, numClickAction$, opClickAction$);
